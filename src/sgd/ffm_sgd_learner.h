...
class FFMSGDLearner : public Learner {
 public:
  FFMSGDLearner() {
    store_ = nullptr;
    loss_ = nullptr;
  ...
  FFMSGDUpdater* GetUpdater() {
    return CHECK_NOTNULL(std::static_pointer_cast<FFMSGDUpdater>(
