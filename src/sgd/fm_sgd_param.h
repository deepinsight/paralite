 ...
 */
#ifndef DIFACTO_FM_SGD_PARAM_H_
#define DIFACTO_FM_SGD_PARAM_H_
#include <string>
 ...
 * \brief sgd config
 */
struct FMSGDLearnerParam : public dmlc::Parameter<FMSGDLearnerParam> {
  ...
  bool has_aux;
  /** \brief task for predict*/
  int task;
  DMLC_DECLARE_PARAMETER(FMSGDLearnerParam) {
...
struct FMSGDUpdaterParam : public dmlc::Parameter<FMSGDUpdaterParam> {
  ...
  /** \brief random seed */
  unsigned int seed;
  DMLC_DECLARE_PARAMETER(FMSGDUpdaterParam) {
